...
from gui.decompressor import MultiDecompressorWindow
...
if __name__ == "__main__":
    ...
    MultiDecompressorWindow("Example NES MultiDecompressor with GUI", decompress, compress, codec_list=list_of_compressions)